...
export class ContaInvestimento implements ContaBancaria, Tributavel {
    ...
    calcularTaxaAdministracao(taxa_de_rendimento: number): number {
        return taxa_de_rendimento*this.saldo/1000
    }

    calcularTributo(taxa_de_rendimento: number): number {
        return taxa_de_rendimento*this.saldo/2000
    }
